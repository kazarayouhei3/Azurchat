...
"        ")
        icon = QIcon()
        icon.addFile(u":/new/prefix2/go.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border: 1px solid #E0E0E0;")
    ...
    def retranslateUi(self, Widget):
        ...
        self.label.setText(QCoreApplication.translate("Widget", u"\u6ce8\u518c", None))
        self.loginButton.setText(QCoreApplication.translate("Widget", u"\u6ce8\u518c", None))
