...
################################################################################
## Form generated from reading UI file 'fr.ui'
##
...
"        ")
        ...
        sizePolicy2.setHeightForWidth(self.chat.sizePolicy().hasHeightForWidth())
        self.chat.setSizePolicy(sizePolicy2)
...
"        }")
        ...
        sizePolicy2.setHeightForWidth(self.my.sizePolicy().hasHeightForWidth())
        self.my.setSizePolicy(sizePolicy2)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.list, 1, 0, 1, 1)

        self.fr = QPushButton(self.widget_3)
        self.fr.setObjectName(u"fr")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(1)
        sizePolicy4.setHeightForWidth(self.fr.sizePolicy().hasHeightForWidth())
        self.fr.setSizePolicy(sizePolicy4)
        font3 = QFont()
        font3.setFamilies([u"Arial"])
        font3.setPointSize(15)
        font3.setBold(True)
        self.fr.setFont(font3)
        self.fr.setStyleSheet(u"QPushButton {\n"
...
"}")
        ...
        self.gridLayout_4.addWidget(self.fr, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Widget):
        ...
        self.label.setText(QCoreApplication.translate("Widget", u"\u901a\u8baf\u5f55", None))
        self.quit_button.setText("")
        self.chat.setText("")
        self.phone.setText("")
        self.my.setText("")
        self.fr.setText(QCoreApplication.translate("Widget", u"\u52a0\u597d\u53cb", None))
    # retranslateUi
